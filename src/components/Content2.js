...
const Content2 = () => {
  ...
  const steps = [
      ...
      options: [
        {
          value: "cc-1",
          label: "굽기",
          trigger: () => handleOptionSelection2("굽기")
        },
        {
          value: "cc-2",
          label: "끓이기",
          trigger: () => handleOptionSelection2("끓이기")
        },
        {
          value: "cc-3",
          label: "볶기",
          trigger: () => handleOptionSelection2("볶기")
        },
        {
          value: "cc-4",
          label: "찌기",
          trigger: () => handleOptionSelection2("찌기")
        },
        {
          value: "cc-5",
          label: "튀기기",
          trigger: () => handleOptionSelection2("튀기기")
        },
        {
          value: "skip-cc",
          label: "아무거나",
          trigger: () => handleOptionSelection2("조리방법 랜덤선택")
        } //전체선택
      ]
    },
    {
    ...
    },
    {
      ...
      options: [
        {
          value: "요리 종류별",
          label: "요리 종류별로 선택하러 가기",
          trigger: "recipeType"
        },
        {
          value: "cookingMethodChoice",
          label: "이전으로 돌아가기",
          trigger: "cookingMethodChoice"
        },
    ...
    },
    {
      id: "조리방법 랜덤선택",
      message:
        "아무거나를 선택하셨군요! 제맘대로 추천해드릴게요! 마음에 안드신다고 해도.. 거절은 거절해요!",
      trigger: "skip-cc-a"
    },
      ...
      options: [
        {
          value: "rc-1",
          label: "국&찌개",
          trigger: () => handleOptionSelection1("국&찌개")
        },
        {
          value: "rc-2",
          label: "반찬",
          trigger: () => handleOptionSelection1("반찬")
        },
        {
          value: "rc-3",
          label: "밥",
          trigger: () => handleOptionSelection1("밥")
        },
        {
          value: "rc-4",
          label: "일품",
          trigger: () => handleOptionSelection1("일품")
        },
        {
          value: "rc-5",
          label: "후식",
          trigger: () => handleOptionSelection1("후식")
        },
        {
          value: "rc-6",
          label: "기타",
          trigger: () => handleOptionSelection1("기타")
        },
        {
          value: "skip-rc",
          label: "아무거나",
          trigger: () => handleOptionSelection1("요리 종류 랜덤선택")
        },
    ...
    },
    {
      ...
      options: [
        {
          value: "ingredient",
          label: "요리 재료별로 선택하러 가기",
          trigger: "ingredient"
        },
        {
          value: "recipeTypeChoice",
          label: "이전으로 돌아가기",
          trigger: "recipeTypeChoice"
        },
        { value: "result", label: "결과보기", trigger: "result" }
    ...
    },
    {
      id: "일품",
      message:
        "일품은 주식과 부식 같은 한 끼 음식을 그릇에 담아 간편하게 먹을 수 있는 요리랍니다. :) ",
      trigger: "rc-4-a"
    },
    {
      id: "rc-4-a",
    ...
    },
    {
      ...
      options: [
        ...
        { value: "other", label: "그 외의 재료", trigger: "other" },
        {
          value: "skip-ic",
          label: "아무거나",
          trigger: () => handleOptionSelection3("재료 랜덤선택")
        },
      ...
      options: [
        {
          value: "nc-1",
          label: "당면",
          trigger: () => handleOptionSelection3("당면")
        },
        {
          value: "nc-2",
          label: "파스타면",
          trigger: () => handleOptionSelection3("파스타면")
        },
        {
          value: "nc-3",
          label: "라면",
          trigger: () => handleOptionSelection3("라면")
        },
        {
          value: "nc-4",
          label: "다른 면",
          trigger: () => handleOptionSelection3("다른 면")
        },
        {
          value: "nc-5",
          label: "아무거나",
          trigger: () => handleOptionSelection3("면 랜덤선택")
        },
        {
      ...
      options: [
        {
          value: "mc-1",
          label: "소고기",
          trigger: () => handleOptionSelection3("소고기")
        },
        {
          value: "mc-2",
          label: "돼지고기 ",
          trigger: () => handleOptionSelection3("돼지고기")
        },
        {
          value: "mc-3 ",
          label: "닭고기 ",
          trigger: () => handleOptionSelection3("닭고기")
        },
        {
          value: "mc-4",
          label: "다른 고기",
          trigger: () => handleOptionSelection3("다른 고기")
        },
        {
          value: "mc-5",
          label: "아무거나",
          trigger: () => handleOptionSelection3("육류 랜덤선택")
        },
        {
          value: "ingredientChoice",
          label: "이전으로 돌아가기",
      ...
      options: [
        {
          value: "새우 ",
          label: "새우 ",
          trigger: () => handleOptionSelection3("새우")
        },
        {
          value: "오징어  ",
          label: "오징어  ",
          trigger: () => handleOptionSelection3("오징어")
        },
        {
          value: "조개  ",
          label: "조개  ",
          trigger: () => handleOptionSelection3("조개")
        },
        {
          value: "sc-4",
          label: "다른 생선류",
          trigger: () => handleOptionSelection3("다른 생선류")
        },
        {
          value: "sc-5",
          label: "다른 두족류",
          trigger: () => handleOptionSelection3("다른 두족류")
        },
        {
          value: "sc-6",
          label: "그 이외의 해산물",
          trigger: () => handleOptionSelection3("그 이외의 해산물")
        },
        {
          value: "sc-7",
          label: "아무거나",
          trigger: () => handleOptionSelection3("해산물 랜덤선택")
        },
        {
          value: "ingredientChoice",
          label: "이전으로 돌아가기",
    ...
    },
    {
      id: "그 이외의 해산물",
      message:
        "홍합, 전복, 굴, 꼬막, 바지락, 소라, 멍게, 꽃게 로 요리를 해보아용",
      trigger: "sc-6-a"
    },
    {
      id: "sc-6-a",
      ...
      options: [
        {
          value: "dc-1",
          label: "우유 ",
          trigger: () => handleOptionSelection3("우유")
        },
        {
          value: "치즈   ",
          label: "치즈",
          trigger: () => handleOptionSelection3("치즈")
        },
        {
          value: "버터   ",
          label: "버터",
          trigger: () => handleOptionSelection3("버터")
        },
        {
          value: "생크림 ",
          label: "생크림",
          trigger: () => handleOptionSelection3("생크림")
        },
        {
          value: "dc-5",
          label: "요거트류",
          trigger: () => handleOptionSelection3("요거트류")
        },
        {
          value: "ingredientChoice",
          label: "이전으로 돌아가기",
      ...
      options: [
        {
          value: "oc-1",
          label: "김치",
          trigger: () => handleOptionSelection3("김치")
        },
        {
          value: "oc-2",
          label: "달걀",
          trigger: () => handleOptionSelection3("달걀")
        },
        {
          value: "oc-3",
          label: "두부",
          trigger: () => handleOptionSelection3("두부")
        },
        {
          value: "oc-4",
          label: "가공식품",
          trigger: () => handleOptionSelection3("가공식품")
        },
        {
          value: "ingredientChoice",
          label: "이전으로 돌아가기",
  ...
  return (
    <ThemeProvider theme={Theme}>
      ...
      <p>
        조리 방법 : {selectedway}, 요리 종류 : {selectedtype}, 재료 :{" "}
        {selectedingre}
      </p>
      <div>
        {/* <button className="tmpbtn" onClick={setResult}>
          히히 백엔드로 못가
        </button> */}
      </div>
    </ThemeProvider>
