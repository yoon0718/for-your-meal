...
function VoiceResultCook() {
  ...
  const emotionTips = {
    "0":
      "화가 났을 때는 집중력을 높이는 활동을 해보세요. 요리를 하거나 책을 읽는 것이 좋습니다.",
      ...
      <div className={`color-change-5x`}>
        ...
        <main className="Voicecontents">
          <div className="Voicefoodresipe">
            <img
              src={process.env.PUBLIC_URL + "/images/" + food_image}
              alt={`Food ${food_name}`}
            />
          ...
          <div className="VoicerecipeDetails">
            <div className="VoiceText">
              ...
              <div className="Voiceingredient1">{emotion}</div>
