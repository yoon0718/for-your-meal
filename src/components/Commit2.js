...
const contentImages = [
  { src: Food1, label: "반찬 예시 1", path: "/" },
  { src: Food2, label: "반찬 예시 2", path: "/" },
  { src: Food3, label: "반찬 예시 3", path: "/" },
  { src: Food4, label: "반찬 예시 4", path: "/" },
  { src: Food5, label: "반찬 예시 5", path: "/" },
  { src: Food6, label: "반찬 예시 6", path: "/" },
];
